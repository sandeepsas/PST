...
public final class EdmondsMatching {
     ...
     */
    private static <T> void updateMatching(List<T> path, MUndirectedGraph<T> m) {
     ...
     */
    private static <T> List<T> findAlternatingPath(MUndirectedGraph<T> g,
                                                   MUndirectedGraph<T> m) {
     ...
     */
    private static <T> MUndirectedGraph<T> contractGraph(MUndirectedGraph<T> g,
                                                        Blossom<T> blossom) {
     ...
     *         node.
     */
    private static <T> T findNodeLeavingCycle(MUndirectedGraph<T> g,
                                              Blossom<T> blossom,
                                              T node) {
