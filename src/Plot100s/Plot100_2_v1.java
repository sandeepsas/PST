...
public class Plot100_2_v1 {
	...
	public static void main (String[] args0) throws IOException, ClassNotFoundException{
		PrintStream out = new PrintStream(new FileOutputStream("out_P100_p2_5minWalk_v1.csv"));
		System.setOut(out);
		...
		PrintWriter merge_trips_writer = new PrintWriter(new FileWriter ("Plot100_P2_5minWalk_v1.csv"));
