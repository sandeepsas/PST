...
public class RUNSETTINGS {
	...
	public static String IntersectionMapFile = "ObjectWarehouse/WalkableIntersectionMap/IntrMap_5min.csv";
	public static String VertexMapFile = "ObjectWarehouse/IntersectionVertexMap/VertexMap_5min.csv";
