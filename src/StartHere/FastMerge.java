...
public class FastMerge {
	public static final Logger LOGGER = Logger.getLogger(FastMerge.class.getName());
	...
	public static void main (String[] args0) throws IOException, ClassNotFoundException{
		...
		FastMerge.LOGGER.info("Total No of trips in the pool = "+trips.size());
		...
		FastMerge.LOGGER.info("Summary Printing Started");  
		//Print Results
