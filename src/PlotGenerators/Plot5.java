...
public class Plot5 {
	...
	public static void main (String[] args0) throws IOException, ClassNotFoundException{
		...
		PrintStream out = new PrintStream(new FileOutputStream("output_Plot5_10_v1.txt"));
		System.setOut(out);
		
		PrintWriter merge_trips_writer = new PrintWriter(new FileWriter ("Plot_5_10_v1.txt"));
		PrintWriter merge_trips_coll= new PrintWriter(new FileWriter ("Plot_5_coll_10_v1.txt"));
		...
		DateTime endTime = Constants.dt_formatter.parseDateTime("2013-01-13 10:05:00");
