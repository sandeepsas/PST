...
public class Plot2 {
	...
	public static void main (String[] args0) throws IOException, ClassNotFoundException{
		...
		PrintStream out = new PrintStream(new FileOutputStream("output_10.txt"));
		System.setOut(out);
		
		PrintWriter merge_trips_writer = new PrintWriter(new FileWriter ("Plot_2.txt"));
		PrintWriter merge_trips_coll= new PrintWriter(new FileWriter ("Plot_2_coll.txt"));
		...
		while(startTime.compareTo(endTime)<0){
			...
			DateTime duration = startTime.plusMinutes(10);
